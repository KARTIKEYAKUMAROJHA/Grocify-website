...
const Hero = () => {
  return (
   <section>
<div className=' min-h-screen max-w-[1400px] mx-auto px-10 flex  md:flex-row flex-col items-center  ms:pt-25 pt-35 '>
  {/* Hero content */}
  ...
  <h1 className='md:text-7xl/20 text-5xl/14  font-bold mt-4'>
    ...
    <p className='text-zinc-600 md:text-lg text-md max-w-[530px] mt-5 mb-10'>
        Bred for a high content of beneficial substances, Our products are all fresh and 100% organic.
    </p>

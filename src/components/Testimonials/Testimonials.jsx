    ...
    <section>
      <div className="max-w-[1400px] px-10  mx-auto py-20">
         ...
         modules={[Navigation]} className="mySwiper">
       {
        review.map(item => {
            return(
                <SwiperSlide className=' bg-zinc-100 roundef-xl p-8'>
...
const review = [
  {
    ...
    rating: 3,
    para: "FreshBasket is my go-to store for all grocery needs.Their produce is always fresh, and the delivery is super fast. I love the user friendly interface and veriety of organic options!",
    image: Customer1,
  },
  {
    id: 2,
